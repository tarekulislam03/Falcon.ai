...
/**
 * Interface defining message format between Frontend <-> Backend <-> AI
 */
...
export class AIBridgeService {
   ...
   */
  public async generateResponse(payload: ChatRequestPayload): Promise<string> {
    try {
   ...
   */
  public async streamResponse(payload: ChatRequestPayload, res: Response): Promise<void> {
